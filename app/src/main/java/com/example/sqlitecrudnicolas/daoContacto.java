package com.example.sqlitecrudnicolas;
...
public class daoContacto {
    ...
    public ArrayList<Contacto>verTodo(){
        ...
        if(cursor!=null &&cursor.getCount()>0){
            cursor.moveToFirst();
            do{
                lista.add(new Contacto(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3)
    ...
    public Contacto verUno(int posicion){
        ...
        c= new Contacto(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getString(3)
                ,cursor.getString(4),cursor.getString(5));
        return c;
    }
}
